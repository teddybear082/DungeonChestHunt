...
func _ready():
	...
	l_grapple_node = left_controller.get_node("Function_Grapple_movement")
	r_grapple_node = right_controller.get_node("Function_Grapple_movement")
	l_jump_node = left_controller.get_node("Function_Jump_movement")
	r_jump_node = right_controller.get_node("Function_Jump_movement")
	l_turn_node = left_controller.get_node("Function_Turn_movement")
	r_turn_node = right_controller.get_node("Function_Turn_movement")
